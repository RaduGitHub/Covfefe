...
namespace Covfefe
{
    public class Startup
    {
        ...
        private async Task CreateRoles(IServiceProvider serviceProvider)
        {
            ...
            //var user = new Banker { UserName = Input.Email, Email = Input.Email }; 
            if (UserManager.FindByNameAsync("admin@admin.com").Result == null)
            {
                var user = new User { UserName = "admin@admin.com", Email = "admin@admin.com", EmailConfirmed = true };
